...
| :---: | :---: | :---: |
| 해설마다 꼬리질문 5개.<br />없으면 그 자리에서 새로 만듭니다 | 335개 질문을 별자리처럼.<br />파고든 길은 진한 선으로 남습니다 | 파고든 날이 잔디로 쌓이고<br />이미지로 공유할 수 있습니다 |
...
꼬리질문에 `이미 파인 길 · 바로 이동` 배지가 있으면 누군가 이미 파고든 질문입니다 — 만들지 않고 곧바로 이동합니다. 없으면 그 자리에서 새로 만드는데 20~40초쯤 걸립니다. 다섯 개 중 마음에 드는 게 없으면 직접 적어도 됩니다.
...
- **내 기록** — 며칠에 몇 편 파고들었는지 잔디로 쌓입니다. 이미지로 저장해 공유할 수 있고, 그림은 브라우저 안에서 그립니다
