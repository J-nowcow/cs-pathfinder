...
const CASES = [
  ...
  },
  {
    ...
    note: '갈래 안쪽에서 맨 위 마디로 되돌아간다. 점선 괄호가 되돌아가는 선이고, 아래 칩이 몇 번 마디로 가는지 말한다.',
    body: [
      ':::flow',
  ...
  return (
    <main className="mx-auto max-w-[880px] px-5 py-8">
      ...
      <div className="mb-8 space-y-2 text-[14px] leading-[1.7] text-muted">
        ...
        <p>
          갈림은 왼쪽 트렁크에서 팔을 뻗어 조건 칩을 달고, 되돌아감은 점선 괄호가 되돌아가는 선을
          대신한다. 괄호 높이는 브라우저가 정한다(
          <code className="font-mono text-[13px]">inset-y-0</code>). 좌표를 손으로 계산하지 않으므로
          반려된 SVG 시안처럼 이름표가 포개질 자리가 없다.
        </p>
        <p>
